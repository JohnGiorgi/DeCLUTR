...
@Tokenizer.register("pretrained_transformer_fix")
class PretrainedTransformerTokenizerFix(Tokenizer):
    """
    This is a copy/paste of the `PretrainedTransformerTokenizer` from AllenNLP 2.4.0. It fixes
    as bug which causes the underlying HuggingFace transformer for truncate text when it shouldn't.
    This could be dropped if the entire codebase was ported to AllenNLP>=2.0.
    """
